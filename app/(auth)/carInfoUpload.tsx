                    ...
                    <PaddedScreen styles={wHFull}>
                        ...
                        <View style={[flexCol, gap(16),]}>
                            ...
                            <FileUploadTile
                                ...
                                layout="stack"
                                styles={{ container: {}, label: {} }}
                                placeholder={{ success: false, hasError: true, uploadHelper: () => { }, imgNotClear: false }}
                            />
                            <FileUploadTile
                                label="Interior"
                                layout="stack"
                                styles={{ container: {}, label: {} }}
                                placeholder={{ success: true, hasError: true, uploadHelper: () => { }, imgNotClear: true }}
                            />
                        </View>

                        <TouchableRipple
                            onPress={() => router.replace(`/(auth)/docsUpload` as Href)} rippleColor={colors.white} style={[h(50), rounded(10), flexCol, wFull, itemsCenter, justifyCenter, bg(Colors.light.background), mb(30), mt(30)]}>
