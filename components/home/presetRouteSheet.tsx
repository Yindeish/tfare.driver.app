    ...
    <BottomSheetScrollView>
      <View style={[flexCol, gap(32), p(20)]}>
        ...
        >
          ...
          <Text style={[rounded(1000) as TextStyle, c(Colors.light.darkGrey)]}>
            Search Bus stop
          </Text>
        </TouchableOpacity>
        {/* //!Search Block */}
        ...
        <TouchableOpacity
          onPress={() =>
            selectedRoute && router.push("/(route)/customizeRoute")
          }
        >
          <View
            style={[
              ...
              bg(colors.white),
              borderGrey(0.7),
              { shadowColor: "#000000", shadowOpacity: 0.05, shadowRadius: 10 },
            ]}
          >
            <Image
              style={[image.w(20), image.h(20)]}
              source={sharedImg.blackBgPlusIcon}
            />

            <Text style={[neurialGrotesk, fw700, fs18, c(colors.black)]}>
              Create Custom Route
            </Text>
          </View>
        </TouchableOpacity>
